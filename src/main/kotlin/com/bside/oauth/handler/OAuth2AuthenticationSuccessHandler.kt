...
class OAuth2AuthenticationSuccessHandler(
    ...
    private fun setTokenCookie(
        ...
        CookieUtil.addLocalCookie(response, ACCESS_TOKEN, tokenDto.accessToken!!, cookieMaxAge)
        CookieUtil.addLocalCookie(response, REFRESH_TOKEN, refreshToken.value, cookieMaxAge)
    }
